...
COLOR_01=$(rgb_color "#2c2e5b")              # HOST
COLOR_02=$(rgb_color "#ff5877")           # SYNTAX_STRING
COLOR_03=$(rgb_color "#9aff7a")           # COMMAND
...
COLOR_08=$(rgb_color "#b9e1e6")           #

COLOR_09=$(rgb_color "#444c72")           #
...
BACKGROUND_COLOR=$(gnome_color '#2c2e5b')
FOREGROUND_COLOR=$(gnome_color '#b9e1e6')   # Text
CURSOR_COLOR=$(gnome_color '#b47676') # Cursor
